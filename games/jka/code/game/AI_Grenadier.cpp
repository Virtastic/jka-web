...
#include "b_local.h"
// idTech3-web: NPC_Pain's trailing `int hitLoc=HL_NONE` default lives only in
// g_functions.h; b_local.h redeclares it WITHOUT the default (true in the pristine
// import too). MSVC's /YX auto-PCH injected g_functions.h ahead of this TU, so the
// default was in scope and the 6-arg NPC_Pain() calls below compiled. Make the TU
// self-contained instead of relying on that.
