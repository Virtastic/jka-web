...
class hmap : public map<K,V,Compare,CMapPool<pair<const K,V> > >{};	// idTech3-web: libc++ allocator value_type

template <class K,class V,class Compare = less<K> >
class hmultimap : public multimap<K,V,Compare,CMapPool<pair<const K,V> > >{};	// idTech3-web: same
