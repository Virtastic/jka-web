...
typedef	map < string, int, less<string> >		entitylist_t;	// idTech3-web: MSVC allocator mismatch
typedef map < string, pscript_t*, less<string> >	scriptlist_t;	// idTech3-web: same
