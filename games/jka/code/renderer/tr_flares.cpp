...
void RB_TestFlare( flare_t *f ) {
	...
	// idTech3-web: WebGL1 cannot glReadPixels(GL_DEPTH_COMPONENT); the flare occlusion
	// z-test is impossible. Treat the flare as visible (it still fades in over r_flareFade).
	// Avoids per-flare INVALID_ENUM spam every frame.
	(void)depth; (void)screenZ;
	visible = qtrue;
#else
