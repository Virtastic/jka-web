...
typedef	map< sstring_t, unsigned char, less<sstring_t> >	namePrecache_m;	// idTech3-web: MSVC allocator mismatch
...
================
*/
// idTech3-web: C linkage so the engine can dlsym this by plain name out of the side
// module. SP merges cgame into the game module and Sys_LoadCgame pulls "vmMain" /
// "dllEntry" straight out of it (exactly as the original win32 layer does); C++
// mangling would hide them. Same treatment GetGameAPI already has.
extern "C" int vmMain( int command, int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7 ) {
	centity_t		*cent;
