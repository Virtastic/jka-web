...
// idTech3-web: C linkage on dllEntry so the engine can dlsym it by plain name out of
// the side module (Sys_LoadCgame pulls "dllEntry"/"vmMain" from the game module, as
// the original win32 layer does). C++ mangling would hide it.
#ifdef _XBOX
