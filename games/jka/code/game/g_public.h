...
struct Trace_Functor_t
{
	...
	void operator()( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, 
						const int passEntityNum, const int contentMask, const EG2_Collision eG2TraceType = (EG2_Collision)0 /*idTech3-web restored*/, const int useLod = 0 /*idTech3-web restored*/ )
...
/*
extern int		G2API_InitGhoul2Model(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin = NULL /*idTech3-web restored*/,
									  qhandle_t customShader = NULL /*idTech3-web restored*/, int modelFlags = 0 /*idTech3-web restored*/, int lodBias = 0 /*idTech3-web restored*/);
extern qboolean	G2API_SetSkin(CGhoul2Info *ghlInfo, qhandle_t customSkin, qhandle_t renderSkin = 0 /*idTech3-web restored*/);
extern qboolean	G2API_SetBoneAnim(CGhoul2Info *ghlInfo, const char *boneName, const int startFrame, const int endFrame,
								  const int flags, const float animSpeed, const int currentTime, const float setFrame = -1 /*idTech3-web restored*/, const int blendTime = -1 /*idTech3-web restored*/);
extern qboolean	G2API_SetBoneAngles(CGhoul2Info *ghlInfo, const char *boneName, const vec3_t angles, const int flags,
									...
									int blendTime = 0 /*idTech3-web restored*/, int currentTime = 0 /*idTech3-web restored*/);
extern qboolean	G2API_SetBoneAnglesMatrix(CGhoul2Info *ghlInfo, const char *boneName, const mdxaBone_t &matrix, const int flags,
										  qhandle_t *modelList, int blendTime = 0 /*idTech3-web restored*/, int currentTime = 0 /*idTech3-web restored*/);
extern void		G2API_CopyGhoul2Instance(CGhoul2Info_v &Ghoul2From, CGhoul2Info_v &Ghoul2To, int modelIndex = -1 /*idTech3-web restored*/);
...
Ghoul2 Insert End
*/
// idTech3-web: MSVC allowed default args on fn-ptr params (see the _XBOX comment above); wrappers restore them, layout-identical.
#ifndef IDT3_JKA_FP_WRAPPERS
#define IDT3_JKA_FP_WRAPPERS
#ifndef IDT3_TRACE_FP_ONLY
#define IDT3_TRACE_FP_ONLY
struct idt3_trace_fp {
	typedef void (*fn_t)( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, const int passEntityNum, const int contentmask, const EG2_Collision eG2TraceType, const int useLod );
	fn_t fn;
	idt3_trace_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	void operator()( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, const int passEntityNum, const int contentmask, const EG2_Collision eG2TraceType = (EG2_Collision)0, const int useLod = 0 ) const { fn(results,start,mins,maxs,end,passEntityNum,contentmask,eG2TraceType,useLod); }
};
#endif
struct idt3_ReadFromSaveGame_fp {
	typedef int (*fn_t)(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr);
	fn_t fn;
	idt3_ReadFromSaveGame_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
...
struct idt3_G2API_InitGhoul2Model_fp {
	typedef int (*fn_t)(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin, qhandle_t customShader, int modelFlags, int lodBias);
	fn_t fn;
	idt3_G2API_InitGhoul2Model_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	int operator()(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin = 0, qhandle_t customShader = 0, int modelFlags = 0, int lodBias = 0) const { return fn(ghoul2, fileName, modelIndex, customSkin, customShader, modelFlags, lodBias); }
};
struct idt3_G2API_SetSkin_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, qhandle_t customSkin, qhandle_t renderSkin);
	fn_t fn;
	idt3_G2API_SetSkin_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, qhandle_t customSkin, qhandle_t renderSkin = 0) const { return fn(ghlInfo, customSkin, renderSkin); }
};
struct idt3_G2API_SetBoneAnim_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, const char *boneName, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame, const int blendTime);
	fn_t fn;
	idt3_G2API_SetBoneAnim_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, const char *boneName, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame = -1, const int blendTime = -1) const { return fn(ghlInfo, boneName, startFrame, endFrame, flags, animSpeed, currentTime, setFrame, blendTime); }
};
struct idt3_G2API_SetBoneAngles_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, const char *boneName, const vec3_t angles, const int flags, const Eorientations up, const Eorientations right, const Eorientations forward, qhandle_t *modelList, int blendTime, int blendStart);
	fn_t fn;
	idt3_G2API_SetBoneAngles_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, const char *boneName, const vec3_t angles, const int flags, const Eorientations up, const Eorientations right, const Eorientations forward, qhandle_t *modelList, int blendTime = 0, int blendStart = 0) const { return fn(ghlInfo, boneName, angles, flags, up, right, forward, modelList, blendTime, blendStart); }
};
struct idt3_G2API_SetBoneAnglesIndex_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, const int index, const vec3_t angles, const int flags, const Eorientations yaw, const Eorientations pitch, const Eorientations roll, qhandle_t *modelList, int blendTime, int currentTime);
	fn_t fn;
	idt3_G2API_SetBoneAnglesIndex_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, const int index, const vec3_t angles, const int flags, const Eorientations yaw, const Eorientations pitch, const Eorientations roll, qhandle_t *modelList, int blendTime = 0, int currentTime = 0) const { return fn(ghlInfo, index, angles, flags, yaw, pitch, roll, modelList, blendTime, currentTime); }
};
struct idt3_G2API_SetBoneAnglesMatrix_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, const char *boneName, const mdxaBone_t &matrix, const int flags, qhandle_t *modelList, int blendTime, int currentTime);
	fn_t fn;
	idt3_G2API_SetBoneAnglesMatrix_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, const char *boneName, const mdxaBone_t &matrix, const int flags, qhandle_t *modelList, int blendTime = 0, int currentTime = 0) const { return fn(ghlInfo, boneName, matrix, flags, modelList, blendTime, currentTime); }
};
struct idt3_G2API_CopyGhoul2Instance_fp {
	typedef void (*fn_t)(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex);
	fn_t fn;
	idt3_G2API_CopyGhoul2Instance_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	void operator()(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex = -1) const { fn(ghoul2From, ghoul2To, modelIndex); }
};
struct idt3_G2API_SetBoneAnimIndex_fp {
	typedef qboolean (*fn_t)(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame, const int blendTime);
	fn_t fn;
	idt3_G2API_SetBoneAnimIndex_fp &operator=( fn_t f ) { fn = f; return *this; }
	operator fn_t() const { return fn; }
	qboolean operator()(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame = -1, const int blendTime = -1) const { return fn(ghlInfo, index, startFrame, endFrame, flags, animSpeed, currentTime, setFrame, blendTime); }
};
#endif // IDT3_JKA_FP_WRAPPERS
...
typedef struct {
	...
	int			ReadFromSaveGame(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr = NULL /*idTech3-web restored*/)
	{
		return SG_Read(chid, pvAddress, iLength, ppvAddressPtr);
	}

	int			ReadFromSaveGameOptional(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr = NULL /*idTech3-web restored*/)
	{
		return SG_ReadOptional(chid, pvAddress, iLength, ppvAddressPtr);
	}
#else
	idt3_ReadFromSaveGame_fp ReadFromSaveGame; //idTech3-web
	idt3_ReadFromSaveGame_fp ReadFromSaveGameOptional; //idTech3-web
#endif
...
#else
	idt3_trace_fp trace; //idTech3-web
#endif
...
qhandle_t	(*G2API_PrecacheGhoul2Model)(const char *fileName);
...
#ifdef _XBOX	// No default arguments through function pointers
	int			G2API_InitGhoul2Model(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin = NULL /*idTech3-web restored*/,
								  qhandle_t customShader = NULL /*idTech3-web restored*/, int modelFlags = 0 /*idTech3-web restored*/, int lodBias = 0 /*idTech3-web restored*/)
	{
		return ::G2API_InitGhoul2Model(ghoul2, fileName, modelIndex, customSkin, customShader, modelFlags, lodBias);
	}

	qboolean	G2API_SetSkin(CGhoul2Info *ghlInfo, qhandle_t customSkin, qhandle_t renderSkin = 0 /*idTech3-web restored*/ )
	{
	...
	qboolean	G2API_SetBoneAngles(CGhoul2Info *ghlInfo, const char *boneName, const vec3_t angles,
								   ...
								   qhandle_t *modelList, int blendTime = 0 /*idTech3-web restored*/, int blendStart = 0 /*idTech3-web restored*/)
	{
	...
	void		G2API_CopyGhoul2Instance(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex = -1 /*idTech3-web restored*/)
	{
	...
	qboolean	G2API_SetBoneAnimIndex(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame = -1 /*idTech3-web restored*/, const int blendTime = -1 /*idTech3-web restored*/)
	{
...
idt3_G2API_InitGhoul2Model_fp G2API_InitGhoul2Model; //idTech3-web
idt3_G2API_SetSkin_fp G2API_SetSkin; //idTech3-web
idt3_G2API_SetBoneAnim_fp G2API_SetBoneAnim; //idTech3-web
idt3_G2API_SetBoneAngles_fp G2API_SetBoneAngles; //idTech3-web
idt3_G2API_SetBoneAnglesIndex_fp G2API_SetBoneAnglesIndex; //idTech3-web
idt3_G2API_SetBoneAnglesMatrix_fp G2API_SetBoneAnglesMatrix; //idTech3-web
idt3_G2API_CopyGhoul2Instance_fp G2API_CopyGhoul2Instance; //idTech3-web
idt3_G2API_SetBoneAnimIndex_fp G2API_SetBoneAnimIndex; //idTech3-web
#endif
