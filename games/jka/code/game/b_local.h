...
//NPC_reactions.cpp
extern void NPC_Pain( gentity_t *self, gentity_t *inflictor, gentity_t *attacker, const vec3_t point, int damage, int mod ,int hitLoc);	// idTech3-web: const + signature aligned with g_functions.h (which carries the default)
